...
for a GitHub PR, by shelling out to:
...
Usage:
  ...
  python fetch_comments.py --url https://github.com/OWNER/REPO/pull/123
  python fetch_comments.py --repo OWNER/REPO --pr 123
"""
...
def parse_args() -> argparse.Namespace:
    ...
    if args.url and (args.repo or args.pr):
        parser.error("--url cannot be combined with --repo/--pr")
